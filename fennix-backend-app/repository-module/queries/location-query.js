...
//SUPER_ADMIN
const selectCenterIdsForSuperAdminQuery = 'select (select localized_text from localization where locale_key = loc.locale_key and language = $2) as country_name,location_id, loc.locale_key from location loc where location_id = (select location_id from users where user_id = $1)';
