const {listTicketsBasedOnUserIdAccessor, totalNoOfTicketsBasedOnUserIdAccessor, ticketAggregatorAccessor, ticketListBasedOnTicketStatusAccessor} = require('../../repository-module/data-accesors/ticket-accesor');
...
//             beneficiaryIdNameMap[item['beneficiaryid']] = item['full_name'];
//         });
//     }
...
//                 beneficiaryName: beneficiaryIdNameMap[item['beneficiaryId']],
//                 locationId: item['locationId'],
//                 withAlerts: item['withAlerts'],
//                 imeiNumber: arrayNotEmptyCheck(item['device']) ? item['device'][0]['imei'] : null,
//                 alertDeviceType: arrayNotEmptyCheck(item['deviceType']) ? item['deviceType'][0]['name'] : null,
//                 alertType: notNullCheck(item['alertType']) ?item['alertType']: 'General alert',
//                 readStatus: item['readStatus'],
//                 createdDate: item['createdDate'],
//                 updatedDate: notNullCheck(item['updatedDate'])?item['alertType']: 'General alert'
//             };
